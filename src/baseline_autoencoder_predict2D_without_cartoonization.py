...
with open('model_2D_without_cartoonization_'+str(epochs)+'.json', "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights('model_2D_without_cartoonization_'+str(epochs)+'.h5')
...
json_file = open('model_2D_without_cartoonization_'+str(epochs)+'.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
# load weights into new model
loaded_model.load_weights('model_2D_without_cartoonization_'+str(epochs)+'.h5')
