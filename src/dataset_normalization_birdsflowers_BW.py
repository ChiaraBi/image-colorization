...
np.save('../resources/data_train_birdsflowers_BW'+LOO, data_train)
...
np.save('../resources/data_test_birdsflowers_BW', data_test)


data_train = np.load('../resources/data_train_birdsflowers_BW'+LOO+'.npy')
data_test = np.load('../resources/data_test_birdsflowers_BW.npy')
...
np.save('../resources/train_mean_birdsflowers_BW'+LOO, train_mean)
np.save('../resources/train_std_birdsflowers_BW'+LOO, train_std)
np.save('../resources/data_train_scaled_birdsflowers_BW'+LOO, data_train_scaled)
np.save('../resources/data_test_scaled_birdsflowers_BW', data_test_scaled)
