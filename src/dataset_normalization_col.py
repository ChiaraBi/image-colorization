...
model = 'dahl'
orig_test = '../img/colorized/'+model+'/finetuning_test_/'
...
np.save('../resources/data_train_orig', data_train)
'''
...
np.save('../resources/data_test_'+model, data_test)


# data_train = np.load('../resources/data_train_orig.npy')
data_test = np.load('../resources/data_test_'+model+'.npy')
...
train_mean = np.load('../resources/train_mean_orig.npy')
train_std = np.load('../resources/train_std_orig.npy')
'''
...
# np.save('../resources/train_mean_orig', train_mean)
# np.save('../resources/train_std_orig', train_std)
# np.save('../resources/data_train_scaled_orig', data_train_scaled)
np.save('../resources/data_test_scaled_'+model, data_test_scaled)
